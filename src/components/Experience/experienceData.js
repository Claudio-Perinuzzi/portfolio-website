export const experienceData = [
    {
        ...
        description: [
            ...
            { text: '', break: true },
            { text: '', break: true },
            { text: 'Act as the EMR administrator, overseeing ', highlight: false },
            { text: 'system configuration, optimizing performance, managing user access, and troubleshooting ', highlight: true },
