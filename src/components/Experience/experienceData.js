export const experienceData = [
    {
        ...
        title: 'Software Application Developer/Data Manager',
        time: 'May 2016 - Present',
        description: [
            { text: 'Develop and deploy custom ', highlight: false },
            { text: 'Python software applications to seamlessly integrate with EMR systems, ', highlight: true },
